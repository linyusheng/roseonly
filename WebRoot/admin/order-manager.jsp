...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>js/order-manager.js"></script>
		<style type="text/css">
	...
	<body>
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				<c:forEach var="order" items="${pageVO.rows}">
				<tr>
					<td>
					...
					<td>${order.status }</td>
					<td>
						<a href="orderManager?method=delete&orderId=${order.orderId }" class="btn btn-default btn-xs delete">
		...
		<jsp:include flush="true" page="orderPage.jsp"></jsp:include>
