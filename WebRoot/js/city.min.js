...
$(function(){
    J_FormDeliver = $('form[name=J_FormDeliver]'),
        prev = $('input[name=cho_Province]' , J_FormDeliver),
        city = $('input[name=cho_City]' , J_FormDeliver),
        area = $('input[name=cho_Area]' , J_FormDeliver),
        vale = ['请选择省份','请选择城市','请选择地区'];
    J_FormDeliver.submit(function(){
        if(prev.val() == vale[0]){
            alert(vale[0]);
            return false;
        };
